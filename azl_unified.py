...
TIERS = {
    ...
    2: {"name": "NGC_IC_HIP", "end": 1200000},
    3: {"name": "GaiaDR3", "end": 10000000},
    4: {"name": "SDSS", "end": 100000000},
    5: {"name": "2MASS", "end": 500000000},
    6: {"name": "WISE", "end": 2000000000},
    7: {"name": "PanSTARRS", "end": 10000000000},
}
...
def main():
    ...
    for shard_idx in range(1, total_shards + 1):
        ...
        if shard_idx % BATCH_SIZE == 0 or shard_idx == total_shards:
            ...
            zip_path = f"azl_batch_{batch_num:03d}.zip"
            ...
            log(f"[AZL] Batch {batch_num} complete.")
